...
import { AlertTriangle, TrendingUp, CreditCard, PiggyBank, CheckCircle2, X } from 'lucide-react';
...
const notifications = [
  {
    ...
    description: 'A $1,250 charge at Best Buy was posted to your Chase Sapphire.',
    time: '2 hours ago',
    unread: true,
  },
  {
    ...
    description: 'You\'ve used 92% of your Dining Out budget for April.',
    time: '5 hours ago',
    unread: true,
  },
  {
    ...
    title: 'Portfolio up 2.3% this week',
    description: 'Your investments gained $2,580 in the past 7 days.',
    time: '1 day ago',
    unread: false,
  },
  {
  ...
  },
  {
    ...
    description: 'Your rent payment of $1,800 was processed.',
    time: '3 days ago',
    unread: false,
  },
];
